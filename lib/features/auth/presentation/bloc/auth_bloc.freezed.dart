...
abstract class _LoggedIn implements AuthState {
  const factory _LoggedIn({required final UserModel user}) = _$LoggedInImpl;
...
class _$LoggedOutImpl implements _LoggedOut {
  const _$LoggedOutImpl({this.isLoggedOut = false});
...
abstract class _LoggedOut implements AuthState {
  const factory _LoggedOut({final bool isLoggedOut}) = _$LoggedOutImpl;
